            ...
            <div className=' h-screen w-screen flex-col flex  place-content-center'>
                ...
                <div className="carousel carousel-center self-center items-center md:w-5/8 px-2 w-2/3 h-1/2 md:h-5/8 rounded-box" >
                    ...
                    <div className=' card carousel-item items-center justify-around place-content-center h-full md:w-1/3 w-full flex flex-col'>
                        ...
                        <img src={techblog} className='h-1/3 w-fit' alt='techblog' ></img><a className='btn h-min w-fit text-2xl text-center btn hover:text-green-400' href="https://github.com/JonkHunkle/techblog" target='_blank'>
                            Repo</a>
                    ...
                    <div className='flex carousel-item card h-full w-full flex-col justify-around md:w-1/3'>
                        ...
                        <img className='h-1/3 self-center' src={project1} />
                    ...
                    <div className='flex card h-full w-full md:w-1/3 carousel-item  justify-around  flex-col'>
                        <a href="https://jonkhunkle.github.io/Day-planner/" target="_blank"
                            className='text-4xl btn self-center h-min hover:text-green-400'>Day Planner
                        </a>
                        <img className='self-center h-1/3 w-auto' src={planner} />
                        <a href="https://github.com/JonkHunkle/Day-planner" target='_blank'
                            className='text-2xl hover:text-green-400 btn w-fit self-center'>Repo</a>
                    ...
                    <div className='flex carousel-item card h-full w-full md:w-1/3 justify-around flex-col'>
                        <a href="https://textpwa.herokuapp.com/" target="_blank" className='text-4xl btn self-center h-min hover:text-green-400'>Text Editor
                        </a>
                        <img className='h-1/3 self-center' src={text} />
                        <a href="https://github.com/JonkHunkle/textPWA" target='_blank' className='text-2xl hover:text-green-400 btn  self-center '>Repo</a>
